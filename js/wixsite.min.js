$(function () {
    ...
    if (w_w < 540 && $(window).scrollTop() > $(window).height() && $(window).scrollTop() < $(document).height() - $(window).height()) {
        $("#to-top").fadeIn();
    } else {
        $("#to-top").fadeOut();
    }
    ...
    $(".menu.iconfont").on('click', function () {
        if ($(this).hasClass("h")) {
            $(this).removeClass("h");
        } else {
            $(this).addClass("h");
    ...
    //Scroll fadein&out animations with viewport diffrences<a>
    function ScrollInitalizing() {
        if (w_w < 640) {
    ...
    $(window).on('scroll', function () {
        ScrollInitalizing();
        if (w_w < 540 && $(window).scrollTop() > $(window).height() && $(window).scrollTop() < $("body").height() - $(window).height()) {
            $("#to-top").fadeIn();
        } else {
            $("#to-top").fadeOut();
        }
